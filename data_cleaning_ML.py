...
#-----------Filtering data on verified purchase, review length----------#
    ...
    spark_data = spark_data.drop("review_length","review_head_length","product_category")
    spark_data.repartition(1).write.save(path="hdfs://dbda23:9001/Machine_Learning_data/"+i,format="csv",header ="true", sep= ",")
